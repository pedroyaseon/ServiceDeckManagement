...
O projeto está na versão `1.0.0-beta.3`. A fundação, o Service Host, o Manager,
...
A beta.3 está em validação. Os testes normais usam um backend de SCM em memória
